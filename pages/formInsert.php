    ...
    <div class="col-9" class="text-center">
        <form action="" method="POST" >
            <div class="form-group row text-right">
                ...
                <div class="col-sm-4">
                    <input name="insert-nom" id="nom" type="text" class="form-control"/>
                </div>
            </div>
            <div class="form-group row text-right">
                <label class="col-sm-6 col-form-label">prenom :</label>
                <div class="col-sm-4">
                    <input name="insert-prenom" id="age" type="text" class="form-control"/>
                </div>
            </div>
            <div class="form-group row text-right">
                <label class="col-sm-6 col-form-label">identifiant :</label>
                <div class="col-sm-4">
                    <input name="insert-identifiant" id="age" type="text" class="form-control"/>
                </div>
            </div>
            <div class="form-group row text-right">
                <label class="col-sm-6 col-form-label">password :</label>
                <div class="col-sm-4">
                    <input name="insert-password" id="age" type="password" class="form-control"/>
                </div>
            </div>
            <div class="form-group row text-right">
                <label for="insert-select" class="col-sm-6 col-form-label">Role</label>
                <div class="col-sm-4">
                    <select class="form-control" name="insert-role" id="insert-select">
